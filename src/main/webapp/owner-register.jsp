            ...
            <div class="col-md-8 col-lg-6">
                <div class="card registration-card">
                    <div class="card-header py-4 text-center registration-header">
                        <h3><i class="fas fa-user-tie me-2"></i>Hostel Owner Registration</h3>
                    </div>
                    <div class="card-body p-4">
                        <form action="owner-register-code.jsp" method="post">
                            <div class="mb-3">
                        ...
                        <div class="text-center">
                            <p class="mb-0">Already have an account? <a href="owner-login.jsp">Login here</a></p>
                        </div>
                    </div>
                </div>
            </div>
